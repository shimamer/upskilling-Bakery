                ...
                <div className="row align-items-center">
                    <div className="tasty col-8 col-md-8 col-lg-8 bg-main">
                        <div className="container">
                            <div className="container tasty-pastries py-5">
                                ...
                                <p >Lorem ipsum dolor sit amet, consectetur adipisicing elit. Veniam, rerum deleniti facere reiciendis eligendi repudiandae. Eligendi facilis laudantium dolore inventore!</p>
                                <button className="btn btn-warning btn-round">contact us</button>
                            </div>
                        </div>
                    </div>
                    <div className="logo col-4 col-md-4 col-lg-4">
                        ...
                        <div className="bread">
                            ...
                            <img src={star} className="w-25 star" />
                        </div>
                    </div>
                </div>
